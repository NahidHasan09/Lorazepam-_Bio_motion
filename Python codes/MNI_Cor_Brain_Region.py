...
data_path= r'E:\SocialDetection7T\Nahid_Project\Figures\GLMSingle_vs_SPM\Bio_Src_SPM_fdr0p05_fwhm3_cls10.csv'
output_dir= r'E:\SocialDetection7T\Nahid_Project\Figures\GLMSingle_vs_SPM'

dmn_coords, data= load_cut_coords(data_path)
#####################################################################
...
data.insert(0, 'Region', n)

data.to_csv(os.path.join(output_dir, 'Bio_Src_SPM_fdr0p05_fwhm3_cls10_reg.csv'))
